...
public class RepositoryController {
	...
	public void run() {
		...
		// ActorRepository.....
		Actor a1 = new Actor("Prabhash", "Raju", 1982, null);
		Actor a2 = new Actor("AKshay", "Kumar", 1984, null);
		Actor a3 = new Actor("Sunil", "Shetty", 1995, null);
		Actor a4 = new Actor("Anushka", "Shetty", 1990, null);
		...
		// MovieRepository....
		Movie m1 = new Movie("Bahubali", 2022, g1, null);
		Movie m2 = new Movie("Phir Hera Pheri", 2019, g2, null);
		Movie m3 = new Movie("SitaRaman", 2022, g3, null);
